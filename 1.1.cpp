...
int main()
{
    ...
    const double REFERENCE_VALUE = pow(PI, 2) / 6.0;
    ...
    for (int i = MIN_RANGE; i <= MAX_RANGE; i++) {
        ...
        tempF = float(1.0 / pow(i, 2));
        qSumF += tempF;

        tempD = double(1.0 / pow(i, 2));
        qSumD += tempD;
   ...
   //*****************************     
    ...
    cout << endl << "Обход с начала:" << scientific << endl << endl;
    ...
    //Суммирование с наименьших значений точнее, так как в начале более существены любые, даже наименьшие значения
